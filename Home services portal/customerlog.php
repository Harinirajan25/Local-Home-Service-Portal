...
<style> 
body{ 
background-image: url('images/bg.jpg'); /* Replace 'path_to_your_image.jpg' with the 
actual path to your background image */ 
...
<div class="card"> 
42  
<img src="assets/img/h.jpg" style="height: 180px; width: 150px; margin-left: 130px" 
class="card-img-top" 
alt="..."> 
<div class="card-body"> 
...
name="register" 
id="register">Login</button><br><a href="signup.php" class="ca">Create an 
account</a> 
</form> 
</div> 
</div> 
