...
$cities = 
["trichy","thanjavur","chennai","karur","sirkali","mayiladuthurai","kumbakonam","co
imbatore","thiruvarur","chidambaram","cuddalore","selam","madurai","ooty"]; 
?> 
<style> 
body{ 
background-image: url('images/bg5.jpg'); /* Replace 'path_to_your_image.jpg' with 
...
<hr> 
<section id="about" class="about" style="background-image: url('assets/img/.jpg'); 
background-size: cover; background-position: center;"> 
<div class="container" style="margin-top:80px; margin-bottom: 60px;"> 
<div class="container" data-aos="fade-up"> 
<div  style="color: #ffffff;"class="section-title;"  > 
<h2 class="text-center">Services</h2> 
</div> 
<div class="row"> 
<div class="form-group col-5"> 
<label for=""  style="color: #ffffff;">City</label> 
...
<div class="form-group col-5"> 
<label for=""  style="color: #ffffff;">Who's Required</label> 
...
<tbody> 
<tr> 
<td colspan='7'>Select city and profession..</td> 
</tr> 
</tbody> 
</table> 
</div> 
