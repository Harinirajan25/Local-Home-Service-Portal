...
<style> 
body{ 
background-image: url('images/bg3.jpg'); /* Replace 'path_to_your_image.jpg' with 
...
<input id="adder1" name="adder1" type="text" class="form-control" 
placeholder="Enter Address line-1" 
required> 
</div> 
<div class="form-group"> 
<label for="">Address Line 2</label> 
<input id="adder2" name="adder2" type="text" class="form-control" 
...
<select class="form-control" name="experience" id="experience" placeholder="enter 
your experience"> 
