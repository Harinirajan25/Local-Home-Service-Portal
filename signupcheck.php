...
header("Location: signup.php?error=The confirmation password  does not 
match&$user_data"); 
exit(); 
} 
else{ 
...
$sql2 = "INSERT INTO clients (username, password, name, gender, address, email) 
VALUES('$uname', '$pass', '$name','$gender','$address','$email')"; 
